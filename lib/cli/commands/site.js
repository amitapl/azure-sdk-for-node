...
exports.init = function(cli) {
  ...
  site.command("list").whiteListPowershell().description("List your web sites").option("-s, --subscription <id>", "use the subscription id").execute(function __1(options, _) { var parameters, sites, s; var __frame = { name: "__1", line: 79 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.command("deploymentscript").whiteListPowershell().usage("[options]").description("Generate custom deployment script").option("-r, --repositoryRoot [dir path]", "The root path for the repository (default: .)").option("--aspWAP <projectFilePath>", "Create a deployment script for .NET web application, specify the project file path").option("--aspWebSite", "Create a deployment script for basic website").option("--node", "Create a deployment script for node.js website").option("--php", "Create a deployment script for php website").option("--python", "Create a deployment script for python website").option("--basic", "Create a deployment script for any other website").option("-s, --solutionFile [file path]", "The solution file path (sln)").option("-t, --scriptType [batch|sh]", "The script output type (default: batch)").execute(function __2(name, options, _) { var repositoryRoot, scriptType, projectFile, solutionFile, specifyOneFlagError, exclusionFlags, flagCount, i, projectType; var __frame = { name: "__2", line: 114 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      scriptType = (options.scriptType || "batch");
      projectFile = options.aspWAP;
      solutionFile = options.solutionFile;

      specifyOneFlagError = "Please specify only one of these flags: --wap, --website or --node";

      exclusionFlags = [options.aspWAP,options.php,options.python,options.aspWebSite,options.node,options.basic,];
      flagCount = 0;
      for (i in exclusionFlags) {
        if (exclusionFlags[i]) {
          flagCount++; } ; };
      ...
      if ((flagCount == 0)) {
        return _(new Error("Please specify one of these flags: --aspWAP, --aspWebSite, --php, --python, --basic or --node")); } else {

        if ((flagCount > 1)) {
          return _(new Error("Please specify only one of these flags: --aspWAP, --aspWebSite, --php, --python, --basic or --node")); } ; } ;



      if (options.aspWAP) {
        projectType = "wap"; } else {

        if (options.aspWebSite) {
          projectType = "website"; } else {

          if (options.node) {
            projectType = "node"; }

           else {
            projectType = "basic"; } ; } ; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {



            scriptGenerator.generateDeploymentScript(repositoryRoot, projectType, projectFile, solutionFile, scriptType, log); __then(); }); })(function ___(e, __result) { __tryCatch(_, function __$__2() { if (e) {


              log.error(e.message); __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, _); }); }); });
  ...
  site.command("create [name]").whiteListPowershell().description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("-pu, --publishingUsername <publishingUsername>", "The publishing username for git").option("--github", "configure github on web site and local folder").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __3(nameArg, options, _) { var context;
    ...
    function promptForSiteName(_) { var __frame = { name: "promptForSiteName", line: 240 }; return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
    ...
    function determineIfSiteExists(_) { var sites, hits, displayNameMatches; var __frame = { name: "determineIfSiteExists", line: 248 }; return __func(_, this, arguments, determineIfSiteExists, 0, __frame, function __$determineIfSiteExists() {
    ...
    function promptForLocation(_) { var displayNameMatches; var __frame = { name: "promptForLocation", line: 274 }; return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
    ...
    function copyIisNodeWhenServerJsPresent(_) { var sourcePath; var __frame = { name: "copyIisNodeWhenServerJsPresent", line: 308 }; return __func(_, this, arguments, copyIisNodeWhenServerJsPresent, 0, __frame, function __$copyIisNodeWhenServerJsPresent() {
    ...
    function updateLocalConfigWithSiteName(_) { var cfg; var __frame = { name: "updateLocalConfigWithSiteName", line: 317 }; return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
    ...
    function createSite(_) { var __frame = { name: "createSite", line: 327 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 334 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
    ...
    function addRemoteToLocalGitRepo(_) { var remotes, azureExists, gitUri; var __frame = { name: "addRemoteToLocalGitRepo", line: 350 }; return __func(_, this, arguments, addRemoteToLocalGitRepo, 0, __frame, function __$addRemoteToLocalGitRepo() {
    ...
    function ensureSpaces(context, _) { var __frame = { name: "ensureSpaces", line: 378 }; return __func(_, this, arguments, ensureSpaces, 1, __frame, function __$ensureSpaces() { return (function __$ensureSpaces(__then) {
          if (!context.spaces) {
            return cacheUtils.readSpaces(context, __cb(_, __frame, 2, 31, function ___(__0, __1) { context.spaces = __1; return (function __$ensureSpaces(__then) {
                if ((!context.spaces || !context.spaces.length)) {
                  return site.doSpacesGet(context, __cb(_, __frame, 4, 33, function ___(__0, __2) { context.spaces = __2; __then(); }, true)); } else { __then(); } ; })(__then); }, true)); } else { __then(); } ; })(_); }); }; var __frame = { name: "__3", line: 187 }; return __func(_, this, arguments, __3, 2, __frame, function __$__3() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), git: options.git, site: { name: nameArg, webspace: options.location, hostname: options.hostname }, publishingUser: options.publishingUsername, github: { username: options.githubusername, password: options.githubpassword, repositoryFullName: options.githubrepository }, flags: { } }; if ((options.git && options.github)) { return _(new Error("Please run the command with either --git or --github options. Not both.")); } ; return promptForSiteName(__cb(_, __frame, 23, 10, function __$__3() { return determineIfSiteExists(__cb(_, __frame, 24, 10, function __$__3() { return promptForLocation(__cb(_, __frame, 25, 10, function __$__3() { return createSite(__cb(_, __frame, 26, 10, function __$__3() { return (function __$__3(__then) { if ((options.git || options.github)) { if (options.github) { context.lvcClient = linkedRevisionControl.createClient(cli, "github"); } else { if (options.git) { context.lvcClient = linkedRevisionControl.createClient(cli, "git"); } ; } ; return context.lvcClient.init(context, __cb(_, __frame, 36, 12, function __$__3() { return copyIisNodeWhenServerJsPresent(__cb(_, __frame, 39, 12, function __$__3() { return updateLocalConfigWithSiteName(__cb(_, __frame, 40, 12, function __$__3() { return initializeRemoteRepo(__cb(_, __frame, 42, 12, function __$__3() { return (function __$__3(__then) { if (options.git) { return addRemoteToLocalGitRepo(__cb(_, __frame, 45, 14, __then, true)); } else { return (function __$__3(__then) { if (options.github) { return site.ensureRepositoryUri(context, __cb(_, __frame, 47, 14, __then, true)); } else { __then(); } ; })(__then); } ; })(function __$__3() { return context.lvcClient.deploy(context, __cb(_, __frame, 50, 12, __then, true)); }); }, true)); }, true)); }, true)); }, true)); } else { __then(); } ; })(_); }, true)); }, true)); }, true)); }, true)); }); });





  function portalCreateSiteInstruction(context, _) { var href; var __frame = { name: "portalCreateSiteInstruction", line: 388 }; return __func(_, this, arguments, portalCreateSiteInstruction, 1, __frame, function __$portalCreateSiteInstruction() {
  ...
  function getPublishingUser(context, _) { var publishingUsers, filters; var __frame = { name: "getPublishingUser", line: 407 }; return __func(_, this, arguments, getPublishingUser, 1, __frame, function __$getPublishingUser() {
  ...
  function portalGitInitInstruction(context, _) { var href; var __frame = { name: "portalGitInitInstruction", line: 425 }; return __func(_, this, arguments, portalGitInitInstruction, 1, __frame, function __$portalGitInitInstruction() {
  ...
  location.command("list").whiteListPowershell().description("List locations available for your account").execute(function __4(options, _) { var context, spaces, s; var __frame = { name: "__4", line: 448 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
      ...
      return site.doSpacesGet(context, __cb(_, __frame, 5, 23, function ___(__0, __1) { spaces = __1; return (function __$__4(__then) {
  ...
  site.command("portal [name]").whiteListPowershell().description("Opens the portal in a browser to manage your web sites").option("-r, --realm <realm>", "specifies organization used for login").execute(function __5(name, options, _) { var href; var __frame = { name: "__5", line: 471 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
  ...
  site.command("browse [name]").whiteListPowershell().description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __6(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__6", line: 491 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__6(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -490, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").whiteListPowershell().description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __7(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__7", line: 512 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 526 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 527 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;



          repositoryUri = getRepositoryUri(result[0]);
          gitUri = (repositoryUri ? getGitUri(repositoryUri, context.site.name) : "none");
          settings = []; return (function __$__7(__then) {
            if (repositoryUri) {
              return site.ensureRepositoryUri(context, __cb(_, __frame, 23, 12, function __$__7() {
                return site.category("repository").doSettingsGet(context, __cb(_, __frame, 24, 23, function ___(__0, __4) { settings = __4; __then(); }, true)); }, true)); } else { __then(); } ; })(function __$__7() {
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 559 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 580 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 594 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 668 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __8(name, options, _) { var context, progress, result; var __frame = { name: "__8", line: 687 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__8() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__8(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -686, 17, function ___(__0, __2) { return (function __$__8(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__8() {



            progress = cli.progress("Deleting site"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__8() {
                  ...
                  return getChannel().path(context.subscription).path("services").path("webspaces").path(context.site.webspace).path("sites").path(context.site.name).DELETE(__cb(_, __frame, 24, 25, function ___(__0, __3) { result = __3;
                    return cacheUtils.deleteSite(context, __cb(_, __frame, 25, 12, function __$__8() { _(null, null, true); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$__8() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context; var __frame = { name: "__9", line: 725 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__9() {
        ...
        return updateSiteState(getChannel(), context, "Running", __cb(_, __frame, 12, 10, function __$__9() {

          log.info((("Site " + context.site.name) + " has been started")); _(); }, true)); }, true)); }); });


  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __10(name, options, _) { var context; var __frame = { name: "__10", line: 746 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__10() {
        ...
        return updateSiteState(getChannel(), context, "Stopped", __cb(_, __frame, 12, 10, function __$__10() {

          log.info((("Site " + context.site.name) + " has been stopped")); _(); }, true)); }, true)); }); });


  site.command("restart [name]").whiteListPowershell().description("Stop and then start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __11(name, options, _) { var context; var __frame = { name: "__11", line: 767 }; return __func(_, this, arguments, __11, 2, __frame, function __$__11() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__11() {

        log.info("Stopping site", context.site.name);
        return updateSiteState(getChannel(), context, "Stopped", __cb(_, __frame, 11, 10, function __$__11() {

          log.info((("Site " + context.site.name) + " has been stopped, restarting"));
          return updateSiteState(getChannel(), context, "Running", __cb(_, __frame, 14, 10, function __$__11() {
            log.info((("Site " + context.site.name) + " has been restarted")); _(); }, true)); }, true)); }, true)); }); });


  function updateSiteState(channel, context, newState, _) { var progress, result; var __frame = { name: "updateSiteState", line: 785 }; return __func(_, this, arguments, updateSiteState, 3, __frame, function __$updateSiteState() {
  ...
  site.readConfig = function site_readConfig__12(_) { var __frame = { name: "site_readConfig__12", line: 824 }; return __func(_, this, arguments, site_readConfig__12, 0, __frame, function __$site_readConfig__12() {
  ...
  site.writeConfig = function site_writeConfig__13(cfg, _) { var __frame = { name: "site_writeConfig__13", line: 831 }; return __func(_, this, arguments, site_writeConfig__13, 1, __frame, function __$site_writeConfig__13() {
      return site.writeConfigValue("azure.site.name", cfg.name, __cb(_, __frame, 1, 4, function __$site_writeConfig__13() {
        return site.writeConfigValue("azure.site.webspace", cfg.webspace, __cb(_, __frame, 2, 4, _, true)); }, true)); }); };


  site.readConfigValue = function site_readConfigValue__14(name, _) { var result; var __frame = { name: "site_readConfigValue__14", line: 836 }; return __func(_, this, arguments, site_readConfigValue__14, 1, __frame, function __$site_readConfigValue__14() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__14() {

            return exec(("git config --get " + name), __cb(_, __frame, 2, 19, function ___(__0, __1) { result = __1;
              return _(null, ((result.stdout + result.stderr)).trim()); }, true)); }); })(function ___(err, __result) { __tryCatch(_, function __$site_readConfigValue__14() { if (err) {
  ...
  site.writeConfigValue = function site_writeConfigValue__15(name, value, _) { var __frame = { name: "site_writeConfigValue__15", line: 847 }; return __func(_, this, arguments, site_writeConfigValue__15, 2, __frame, function __$site_writeConfigValue__15() {
  ...
  site.doSpacesGet = function site_doSpacesGet__16(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__16", line: 945 }; return __func(_, this, arguments, site_doSpacesGet__16, 1, __frame, function __$site_doSpacesGet__16() {
      log.verbose("Subscription", options.subscription);

      progress = cli.progress("Enumerating locations"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSpacesGet__16() {
            ...
            return getChannel().path(options.subscription).path("services").path("webspaces").path("").GET(__cb(_, __frame, 10, 19, function ___(__0, __1) { result = __1;
              ...
              return cacheUtils.saveSpaces(options, spaces, __cb(_, __frame, 14, 6, function __$site_doSpacesGet__16() {
                return _(null, spaces); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$site_doSpacesGet__16() {
  ...
  site.doSitesGet = function site_doSitesGet__17(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__17", line: 967 }; return __func(_, this, arguments, site_doSitesGet__17, 1, __frame, function __$site_doSitesGet__17() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__17() {

              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 981 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
                ...
                return cacheUtils.saveSites(options, result, __cb(_, __frame, 31, 6, function __$site_doSitesGet__17() {
                  return _(null, sites); }, true)); }, true)); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$site_doSitesGet__17() {
  ...
  site.doSiteConfigPUT = function site_doSiteConfigPUT__18(config, options, _) { var progress, xmlConfig; var __frame = { name: "site_doSiteConfigPUT__18", line: 1058 }; return __func(_, this, arguments, site_doSiteConfigPUT__18, 2, __frame, function __$site_doSiteConfigPUT__18() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__19(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__19", line: 1080 }; return __func(_, this, arguments, site_doRepositoryGet__19, 1, __frame, function __$site_doRepositoryGet__19() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__20(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__20", line: 1085 }; return __func(_, this, arguments, site_doPublishingUsersGet__20, 1, __frame, function __$site_doPublishingUsersGet__20() {
      progress = cli.progress("Retrieving user information"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doPublishingUsersGet__20() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doPublishingUsersGet__20() {
                  ...
                  return getChannel().path(options.subscription).path("services").path("webspaces").path("").query("properties", "publishingUsers").GET(__cb(_, __frame, 10, 36, function ___(__0, __1) { publishingUsers = clean(__1);
                    ...
                    return _(null, publishingUsers); }, true)); }); })(function ___(e, __result) { __tryCatch(_, function __$site_doPublishingUsersGet__20() { if (e) {


                    return _(null, ["","",]); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$site_doPublishingUsersGet__20() { _(null, null, true); }); }); }); })(function ___(__e, __r, __cont) { (function ___(__then) { __tryCatch(_, function __$site_doPublishingUsersGet__20() {
