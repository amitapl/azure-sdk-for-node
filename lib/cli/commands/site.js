...
exports.init = function(cli) {
  ...
  site.command("deploymentscript").whiteListPowershell().usage("[options]").description("Generate custom deployment script").option("-r, --repositoryRoot [dir path]", "The root path for the repository (default: .)").option("--wap <projectFilePath>", "Create a deployment script for .NET web application, specify the project file path").option("--website", "Create a deployment script for basic website").option("--node", "Create a deployment script for node.js website").option("-s, --solutionFile [file path]", "The solution file path (sln)").option("-t, --scriptType [batch|sh]", "The script output type (default: batch)").execute(function __2(name, options, _) { var repositoryRoot, scriptType, projectFile, solutionFile, specifyOneFlagError, projectType; var __frame = { name: "__2", line: 111 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      if (options.wap) {
        if ((options.website || options.node)) {
          return _(new Error(specifyOneFlagError)); } ;
        ...
        if (options.website) {
          ...
          if (options.node) {
            ...
            return _(new Error("Missing project type (--wap, --website or --node")); } ; } ; } ; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {
  ...
  site.command("create [name]").whiteListPowershell().description("Create a new web site").option("-s, --subscription <id>", "use the subscription id").option("--location <location>", "the geographic region to create the website").option("--hostname <hostname>", "custom host name to use").option("--git", "configure git on web site and local folder").option("-pu, --publishingUsername <publishingUsername>", "The publishing username for git").option("--github", "configure github on web site and local folder").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __3(nameArg, options, _) { var context;
    ...
    function promptForSiteName(_) { var __frame = { name: "promptForSiteName", line: 230 }; return __func(_, this, arguments, promptForSiteName, 0, __frame, function __$promptForSiteName() {
    ...
    function determineIfSiteExists(_) { var sites, hits, displayNameMatches; var __frame = { name: "determineIfSiteExists", line: 238 }; return __func(_, this, arguments, determineIfSiteExists, 0, __frame, function __$determineIfSiteExists() {
    ...
    function promptForLocation(_) { var displayNameMatches; var __frame = { name: "promptForLocation", line: 264 }; return __func(_, this, arguments, promptForLocation, 0, __frame, function __$promptForLocation() {
    ...
    function copyIisNodeWhenServerJsPresent(_) { var sourcePath; var __frame = { name: "copyIisNodeWhenServerJsPresent", line: 298 }; return __func(_, this, arguments, copyIisNodeWhenServerJsPresent, 0, __frame, function __$copyIisNodeWhenServerJsPresent() {
    ...
    function updateLocalConfigWithSiteName(_) { var cfg; var __frame = { name: "updateLocalConfigWithSiteName", line: 307 }; return __func(_, this, arguments, updateLocalConfigWithSiteName, 0, __frame, function __$updateLocalConfigWithSiteName() {
    ...
    function createSite(_) { var __frame = { name: "createSite", line: 317 }; return __func(_, this, arguments, createSite, 0, __frame, function __$createSite() {
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 324 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
    ...
    function addRemoteToLocalGitRepo(_) { var remotes, azureExists, gitUri; var __frame = { name: "addRemoteToLocalGitRepo", line: 340 }; return __func(_, this, arguments, addRemoteToLocalGitRepo, 0, __frame, function __$addRemoteToLocalGitRepo() {
    ...
    function ensureSpaces(context, _) { var __frame = { name: "ensureSpaces", line: 368 }; return __func(_, this, arguments, ensureSpaces, 1, __frame, function __$ensureSpaces() { return (function __$ensureSpaces(__then) {
          if (!context.spaces) {
  ...
  function getPublishingUser(context, _) { var publishingUsers, filters; var __frame = { name: "getPublishingUser", line: 397 }; return __func(_, this, arguments, getPublishingUser, 1, __frame, function __$getPublishingUser() {
  ...
  function portalGitInitInstruction(context, _) { var href; var __frame = { name: "portalGitInitInstruction", line: 415 }; return __func(_, this, arguments, portalGitInitInstruction, 1, __frame, function __$portalGitInitInstruction() {
  ...
  location.command("list").whiteListPowershell().description("List locations available for your account").execute(function __4(options, _) { var context, spaces, s; var __frame = { name: "__4", line: 438 }; return __func(_, this, arguments, __4, 1, __frame, function __$__4() {
  ...
  site.command("portal [name]").whiteListPowershell().description("Opens the portal in a browser to manage your web sites").option("-r, --realm <realm>", "specifies organization used for login").execute(function __5(name, options, _) { var href; var __frame = { name: "__5", line: 461 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() {
  ...
  site.command("browse [name]").whiteListPowershell().description("Open your web site in a browser.").option("-s, --subscription <id>", "use the subscription id").execute(function __6(name, options, _) { var context, cache, siteData, href; var __frame = { name: "__6", line: 481 }; return __func(_, this, arguments, __6, 2, __frame, function __$__6() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 9, 22, function ___(__0, __2) { cache = __2; return (function __$__6(_) {
          var __1 = cache; if (__1) { return _(null, __1); } ; return site.doSiteGet(context, __cb(_, __frame, 10, 40, _, true)); })(__cb(_, __frame, -480, 17, function ___(__0, __3) { siteData = clean(__3);
  ...
  site.command("show [name]").whiteListPowershell().description("Show details for a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __7(name, options, _) { var context, result, repositoryUri, gitUri, settings, data, index; var __frame = { name: "__7", line: 502 }; return __func(_, this, arguments, __7, 2, __frame, function __$__7() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__7() {
        ...
        return async.parallel([function __1(_) { var __frame = { name: "__1", line: 516 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return site.doSiteGet(context, __cb(_, __frame, 0, 34, _, true)); });
        },function __2(_) { var __frame = { name: "__2", line: 517 }; return __func(_, this, arguments, __2, 0, __frame, function __$__2() { return site.doSiteConfigGet(context, __cb(_, __frame, 0, 34, _, true)); }); },], __cb(_, __frame, 13, 23, function ___(__0, __3) { result = __3;
  ...
  function lookupSiteName(context, _) { var cfg; var __frame = { name: "lookupSiteName", line: 549 }; return __func(_, this, arguments, lookupSiteName, 1, __frame, function __$lookupSiteName() {
  ...
  function lookupSiteWebSpace(context, _) { var sites, index; var __frame = { name: "lookupSiteWebSpace", line: 570 }; return __func(_, this, arguments, lookupSiteWebSpace, 1, __frame, function __$lookupSiteWebSpace() {
  ...
  function lookupSiteNameAndWebSpace(context, _) { var cache; var __frame = { name: "lookupSiteNameAndWebSpace", line: 584 }; return __func(_, this, arguments, lookupSiteNameAndWebSpace, 1, __frame, function __$lookupSiteNameAndWebSpace() {
  ...
  function ensureRepositoryUri(context, _) { var siteData, repositoryUri; var __frame = { name: "ensureRepositoryUri", line: 658 }; return __func(_, this, arguments, ensureRepositoryUri, 1, __frame, function __$ensureRepositoryUri() {
  ...
  site.command("delete [name]").whiteListPowershell().description("Delete a web site").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for delete confirmation").execute(function __8(name, options, _) { var context, progress, result; var __frame = { name: "__8", line: 677 }; return __func(_, this, arguments, __8, 2, __frame, function __$__8() {
      ...
      return lookupSiteNameAndWebSpace(context, __cb(_, __frame, 8, 10, function __$__8() {
        ...
        log.info("Deleting site", context.site.name); return (function __$__8(_) {
          var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return confirm((("Delete " + context.site.name) + " site?  (y/n) "), __cb(_, __frame, 11, 33, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -676, 17, function ___(__0, __2) { return (function __$__8(__then) { if (__2) { return _(null); } else { __then(); } ; })(function __$__8() {
  ...
  site.command("start [name]").whiteListPowershell().description("Start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __9(name, options, _) { var context; var __frame = { name: "__9", line: 715 }; return __func(_, this, arguments, __9, 2, __frame, function __$__9() {
  ...
  site.command("stop [name]").whiteListPowershell().description("Stop a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __10(name, options, _) { var context; var __frame = { name: "__10", line: 736 }; return __func(_, this, arguments, __10, 2, __frame, function __$__10() {
  ...
  site.command("restart [name]").whiteListPowershell().description("Stop and then start a web site").option("-s, --subscription <id>", "use the subscription id").execute(function __11(name, options, _) { var context; var __frame = { name: "__11", line: 757 }; return __func(_, this, arguments, __11, 2, __frame, function __$__11() {
  ...
  function updateSiteState(channel, context, newState, _) { var progress, result; var __frame = { name: "updateSiteState", line: 775 }; return __func(_, this, arguments, updateSiteState, 3, __frame, function __$updateSiteState() {
  ...
  site.readConfig = function site_readConfig__12(_) { var __frame = { name: "site_readConfig__12", line: 814 }; return __func(_, this, arguments, site_readConfig__12, 0, __frame, function __$site_readConfig__12() {
  ...
  site.writeConfig = function site_writeConfig__13(cfg, _) { var __frame = { name: "site_writeConfig__13", line: 821 }; return __func(_, this, arguments, site_writeConfig__13, 1, __frame, function __$site_writeConfig__13() {
  ...
  site.readConfigValue = function site_readConfigValue__14(name, _) { var result; var __frame = { name: "site_readConfigValue__14", line: 826 }; return __func(_, this, arguments, site_readConfigValue__14, 1, __frame, function __$site_readConfigValue__14() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_readConfigValue__14() {
  ...
  site.writeConfigValue = function site_writeConfigValue__15(name, value, _) { var __frame = { name: "site_writeConfigValue__15", line: 837 }; return __func(_, this, arguments, site_writeConfigValue__15, 2, __frame, function __$site_writeConfigValue__15() {
  ...
  site.doSpacesGet = function site_doSpacesGet__16(options, _) { var progress, result, spaces; var __frame = { name: "site_doSpacesGet__16", line: 935 }; return __func(_, this, arguments, site_doSpacesGet__16, 1, __frame, function __$site_doSpacesGet__16() {
      log.verbose("Subscription", options.subscription);
  ...
  site.doSitesGet = function site_doSitesGet__17(options, _) { var spaces, channel, progress, result, sites; var __frame = { name: "site_doSitesGet__17", line: 957 }; return __func(_, this, arguments, site_doSitesGet__17, 1, __frame, function __$site_doSitesGet__17() {
      log.verbose("Subscription", options.subscription);
      ...
      return site.doSpacesGet(options, __cb(_, __frame, 3, 17, function ___(__0, __2) { spaces = __2;
        ...
        progress = cli.progress("Enumerating sites"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$site_doSitesGet__17() {
              ...
              return async.map(spaces, function __1(webspace, _) { var __frame = { name: "__1", line: 971 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() {
  ...
  site.doSiteConfigPUT = function site_doSiteConfigPUT__18(config, options, _) { var progress, xmlConfig; var __frame = { name: "site_doSiteConfigPUT__18", line: 1048 }; return __func(_, this, arguments, site_doSiteConfigPUT__18, 2, __frame, function __$site_doSiteConfigPUT__18() {
  ...
  site.doRepositoryGet = function site_doRepositoryGet__19(options, _) { var siteData; var __frame = { name: "site_doRepositoryGet__19", line: 1070 }; return __func(_, this, arguments, site_doRepositoryGet__19, 1, __frame, function __$site_doRepositoryGet__19() {
  ...
  site.doPublishingUsersGet = function site_doPublishingUsersGet__20(options, _) { var progress, publishingUsers; var __frame = { name: "site_doPublishingUsersGet__20", line: 1075 }; return __func(_, this, arguments, site_doPublishingUsersGet__20, 1, __frame, function __$site_doPublishingUsersGet__20() {
