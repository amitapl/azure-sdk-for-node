...
exports.init = function(cli) {
  ...
  scm.command("list [name]").whiteListPowershell().usage("[options] [name]").description("List your git deployments").option("-s, --subscription <id>", "use the subscription id").option("-m, --max <count>", "limit the maximum number of results").execute(function __1(name, options, _) { var context, repositoryUri; var __frame = { name: "__1", line: 73 }; return __func(_, this, arguments, __1, 2, __frame, function __$__1() {
  ...
  scm.command("generate").whiteListPowershell().usage("[options]").description("Generate custom deployment script").option("-r, --repositoryRoot [dir path]", "Root path for the repository (default: .)").option("-t, --projectType <projectType>", "The project type (wap|website|nodejs|other)").option("-p, --projectFile [file path]", "Project file path (only for wap)").option("-s, --solutionFile [file path]", "Solution file path (only for wap or website)").execute(function __2(name, options, _) { var repositoryRoot, projectType, projectFile, solutionFile; var __frame = { name: "__2", line: 98 }; return __func(_, this, arguments, __2, 2, __frame, function __$__2() {
      ...
      solutionFile = options.solutionFile; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$__2() {


            scriptGenerator.generateDeploymentScript(repositoryRoot, projectType, projectFile, solutionFile, log); __then(); }); })(function ___(e, __result) { __tryCatch(_, function __$__2() { if (e) {
  ...
  scm.command("show <commitId> [name]").whiteListPowershell().usage("[options] <commitId> [name]").description("Show your git deployment").option("-s, --subscription <id>", "use the subscription id").option("-d, --details", "display log details").execute(function __3(commitId, name, options, _) { var context, repositoryUri, deployment, data, logs, i, details, j; var __frame = { name: "__3", line: 118 }; return __func(_, this, arguments, __3, 3, __frame, function __$__3() {
      ...
      return cacheUtils.readCommitId(context, __cb(_, __frame, 9, 25, function ___(__0, __2) { var __1 = !(context.id = __2); return (function __$__3(__then) { if (__1) {
            return _(null, log.error((("deployment with " + commitId) + " does not exist"))); } else { __then(); } ; })(function __$__3() {


          return site.ensureRepositoryUri(context, __cb(_, __frame, 13, 26, function ___(__0, __3) { repositoryUri = __3; return (function __$__3(__then) {
              if (repositoryUri) {
                return scm.doDeploymentGet(context, __cb(_, __frame, 15, 25, function ___(__0, __4) { deployment = __4; return (function __$__3(__then) {

                    if (log.format().json) {
                      data = deployment; return (function __$__3(__then) {
                        if (options.details) {
                          return getLogDetails(context, __cb(_, __frame, 20, 24, function ___(__0, __5) { data.logs = __5; __then(); }, true)); } else { __then(); } ; })(function __$__3() {


                        log.json(data); __then(); }); } else {

                      site.logEachData("info", deployment); return (function __$__3(__then) {
                        if (options.details) {
  ...
  scm.command("redeploy <commitId> [name]").whiteListPowershell().usage("[options] <commitId> [name]").description("Redeploy your git deployment").option("-s, --subscription <id>", "use the subscription id").option("-q, --quiet", "quiet mode, do not ask for redeploy confirmation").execute(function __4(commitId, name, options, _) { var context, repositoryUri; var __frame = { name: "__4", line: 170 }; return __func(_, this, arguments, __4, 3, __frame, function __$__4() {
      ...
      return cacheUtils.readCommitId(context, __cb(_, __frame, 9, 25, function ___(__0, __3) { var __2 = !(context.id = __3); return (function __$__4(__then) { if (__2) {
            return _(null, log.error((("deployment with " + commitId) + " does not exist"))); } else { __then(); } ; })(function __$__4() {


          return site.ensureRepositoryUri(context, __cb(_, __frame, 13, 26, function ___(__0, __4) { repositoryUri = __4; return (function __$__4(__then) {
              if (repositoryUri) { return (function __$__4(_) {
                  var __1 = !options.quiet; if (!__1) { return _(null, __1); } ; return site.confirm((("Reploy deployment with " + context.shortId) + " id?  (y/n) "), __cb(_, __frame, 15, 31, function ___(__0, __3) { var __2 = !__3; return _(null, __2); }, true)); })(__cb(_, __frame, -169, 17, function ___(__0, __5) { return (function __$__4(__then) { if (__5) { return _(null); } else { __then(); } ; })(function __$__4() {


                    return scm.doDeploymentPut(context, __cb(_, __frame, 18, 8, function __$__4() {
  ...
  scm.command("github [name]").whiteListPowershell().usage("[options] [name]").description("Links a website to a github account for deployment").option("-s, --subscription <id>", "use the subscription id").option("--githubusername <username>", "The github username").option("--githubpassword <password>", "The github password").option("--githubrepository <repository>", "The github repository full name (i.e. user/repository)").execute(function __5(name, options, _) { var context;
    ...
    function initializeRemoteRepo(_) { var __frame = { name: "initializeRemoteRepo", line: 234 }; return __func(_, this, arguments, initializeRemoteRepo, 0, __frame, function __$initializeRemoteRepo() {
        log.silly("InitializeRemoteRepo");
        return site.doRepositoryPost(context, __cb(_, __frame, 2, 8, function __$initializeRemoteRepo() {
          return site.ensureRepositoryUri(context, __cb(_, __frame, 3, 8, _, true)); }, true)); }); }; var __frame = { name: "__5", line: 203 }; return __func(_, this, arguments, __5, 2, __frame, function __$__5() { context = { subscription: cli.category("account").lookupSubscriptionId(options.subscription), site: { name: name }, github: { username: options.githubusername, password: options.githubpassword, repositoryFullName: options.githubrepository }, flags: { } }; if (!context.github.repositoryFullName) { context.flags = { forceRepositorySelection: true }; } ; return site.ensureRepositoryUri(context, __cb(_, __frame, 21, 6, function __$__5() { return (function __$__5(__then) { if (!context.repositoryUri) { return initializeRemoteRepo(__cb(_, __frame, 24, 8, __then, true)); } else { __then(); } ; })(function __$__5() { context.lvcClient = linkedRevisionControl.createClient(cli, "github"); return context.lvcClient.init(context, __cb(_, __frame, 28, 6, function __$__5() { return context.lvcClient.deploy(context, __cb(_, __frame, 29, 6, _, true)); }, true)); }); }, true)); }); });



  scm.doDeploymentsGet = function scm_doDeploymentsGet__6(context, _) { var maxItems, channel, progress, deployments; var __frame = { name: "scm_doDeploymentsGet__6", line: 241 }; return __func(_, this, arguments, scm_doDeploymentsGet__6, 1, __frame, function __$scm_doDeploymentsGet__6() {
  ...
  scm.doDeploymentGet = function scm_doDeploymentGet__7(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentGet__7", line: 262 }; return __func(_, this, arguments, scm_doDeploymentGet__7, 1, __frame, function __$scm_doDeploymentGet__7() {
  ...
  scm.doDeploymentPut = function scm_doDeploymentPut__8(context, _) { var channel, progress; var __frame = { name: "scm_doDeploymentPut__8", line: 274 }; return __func(_, this, arguments, scm_doDeploymentPut__8, 1, __frame, function __$scm_doDeploymentPut__8() {
  ...
  scm.doLogGet = function scm_doLogGet__9(context, _) { var channel, progress, logs; var __frame = { name: "scm_doLogGet__9", line: 286 }; return __func(_, this, arguments, scm_doLogGet__9, 1, __frame, function __$scm_doLogGet__9() {
  ...
  function listDeployments(context, _) { var deployments, authorLength, messageLength; var __frame = { name: "listDeployments", line: 300 }; return __func(_, this, arguments, listDeployments, 1, __frame, function __$listDeployments() {
  ...
  function getLogDetails(context, _) { var results, logs, progress, i; var __frame = { name: "getLogDetails", line: 318 }; return __func(_, this, arguments, getLogDetails, 1, __frame, function __$getLogDetails() {
      ...
      return scm.doLogGet(context, __cb(_, __frame, 2, 15, function ___(__0, __2) { logs = __2; return (function __$getLogDetails(__then) {
          if ((logs && logs.length)) {
            progress = cli.progress("Retrieving log details"); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$getLogDetails() {
                  ...
                  return async.map(logs, function __1(log, _) { var details; var __frame = { name: "__1", line: 324 }; return __func(_, this, arguments, __1, 1, __frame, function __$__1() { return (function __$__1(__then) {
                        if (log.hasDetails) {
